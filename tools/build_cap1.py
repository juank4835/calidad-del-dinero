...
CONTENT = [
    ...
    'Volvamos a ese café que llegó a su taza esta mañana —y que, si usted es de por aquí, quizá creció en una montaña no muy lejos de donde vive—. Suponga que en Brasil, el mayor productor del mundo, una helada arrasa las cosechas. De pronto hay mucho menos café del que había. ¿Cómo se entera usted, en su ciudad, de que un cultivo se congeló en otro continente? No lee la noticia. No le llega un comunicado. Y sin embargo, se entera —porque el precio del café sube—.',

    'Ese número más alto es un mensaje, aunque no lo parezca. Le está diciendo, a usted y a millones de personas a la vez: “ahora hay menos café; úselo con más cuidado”. Y cada quien responde a su manera, sin coordinarse con nadie. Usted quizás compra un poco menos, o cambia de marca. Un dueño de cafetería ajusta su carta. Un comerciante al otro lado del planeta, viendo el mismo precio, decide que ahora vale la pena enviar su café guardado. Un cafetero en las montañas de Colombia, viendo el mismo número, concluye que este año sembrar más café vale la pena, y planta. Ninguno habló con los demás. Ninguno conoce la historia completa. Cada uno solo vio un número —y el número les dijo lo justo para decidir bien—.',
