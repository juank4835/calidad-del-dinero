...
CONTENT = [
    ...
    ("El hombre del nogal", [
        'Imagine a un hombre del mismo pueblo donde Juan apartaba su sueldo —llamémoslo Jeisson— con un nogal en el fondo de su terreno. Lo plantó su padre, y desde hace años el árbol le da cada otoño una cosecha de nueces que Jeisson vende en la plaza. No es una fortuna, pero es un ingreso fiel: llega todos los años, sin falta, como llegan los otoños.',
        'Un día se aparece un comprador de madera. El nogal es viejo y la madera es buena; el hombre le ofrece, por el árbol entero, lo que Jeisson sacaría de unas quince cosechas de nueces. Una suma considerable, de golpe, hoy.',
        'Jeisson hace la cuenta. Y aquí conviene mirar por encima de su hombro, porque la cuenta que hace es exactamente la que usted haría. Tiene dos opciones. Una: quedarse el árbol y seguir cobrando nueces cada otoño, año tras año, como hasta ahora —y dejárselo a sus hijos, que seguirán cobrando cuando él ya no esté—. Otra: cortarlo, cobrar de una vez el equivalente a quince cosechas, y quedarse sin árbol para siempre.',
        'Si Jeisson confía en el futuro —si cree que habrá otoños, que sus nueces seguirán valiendo, que sus hijos heredarán un árbol vivo y no un tocón— la cuenta es fácil: no vende. Quince cosechas cobradas de a poco, más todas las que vendrán después, más la herencia, valen muchísimo más que la madera de una sola vez. El árbol vivo es un manantial; la madera, un balde. Nadie cambia un manantial por un balde si confía en que el manantial seguirá manando.',
        'Fíjese bien en lo que sostiene esa decisión. No es el amor de Jeisson por los árboles, aunque lo tenga. No es conciencia ecológica, ni virtud, ni una ley que lo obligue. Es una cuenta —y una cuenta que sale a favor de conservar solo si Jeisson puede confiar en que el futuro llegará y se parecerá al presente—. La conservación del bosque, aquí, no es un acto moral. Es el resultado frío de un cálculo que premia la espera. Jeisson guarda el árbol por la misma razón por la que Juan, allá en el capítulo cinco, guardaba parte de su sueldo: porque el futuro le parece lo bastante firme como para que valga la pena esperarlo.',
    ]),
    ("Cámbiele una sola cosa", [
        'Ahora no le toque nada a Jeisson. Déjele su amor por el árbol, su inteligencia, su prudencia, su cariño por los hijos que lo heredarán. No lo vuelva avaro ni tonto. Cámbiele una sola cosa, y la más invisible de todas: el dinero con que cobra las nueces.',
        'Hasta ahora cobraba en dinero honesto, del que no se puede fabricar de la nada. Cada peso que apartaba seguía valiendo el año siguiente, y el siguiente —así que, sin pensarlo, Jeisson tenía un colchón—. Lo que le sobraba de las cosechas buenas lo guardaba para las malas; tenía con qué aguantar una enfermedad, un techo que se cae, un año flaco. Y porque tenía con qué aguantar, podía esperar. El nogal le daba de a poco, año tras año, y a él le bastaba con eso, porque tenía un respaldo debajo.',
        'Cámbiele ese dinero por uno que se diluye cada año. Y mire lo primero que desaparece: el colchón. Ahora lo que Jeisson aparta se le derrite en las manos —guardar es perder—, así que deja de guardar. No por imprudente: porque ahorrar dejó de servir de nada. Lo vio usted entero en el capítulo del ahorro real: con dinero que no preserva valor, el ahorro ya no guarda pedazos del mundo para después; no guarda nada. Y un hombre que no puede ahorrar es un hombre que no puede esperar —porque esperar quince años de cosechas exige tener con qué vivir mientras llegan, y eso es precisamente lo que ya no tiene—.',
        'Aquí es donde la sensación se vuelve física, y conviene que la sienta usted también. Jeisson tiene un nogal que es un manantial, sí: le dará nueces durante quince otoños. Pero hoy le llegó la cuenta del médico, o se le cayó media casa, o simplemente no alcanzó el mes. Y no hay colchón debajo, porque el dinero se lo comió. El manantial no sirve para hoy —el manantial da de a gotas, año tras año—. Lo que la urgencia exige es un balde lleno, ahora. Y resulta que Jeisson tiene un balde a la mano: el árbol entero, vendido como madera, pagado de golpe. El nogal, que era su futuro, es de pronto lo único líquido que le queda. Es la reserva que no pudo tener en ninguna otra forma, porque el dinero le impidió tenerla.',
        'Jeisson levanta el hacha. No porque dejó de querer el árbol, sino porque el dinero le quitó toda otra forma de aguantar el presente —y cuando el presente aprieta y no hay colchón, hasta el manantial se vende por un balde—.',
    ...
    ("La cifra falsificada", [
        'Recuerde la tasa que miente. La decisión de Jeisson —conservar o talar— es, mírela bien, exactamente ese cálculo: compara un flujo de ingresos futuros (las nueces de muchos años) contra una suma presente (la madera de una vez), y para decidir tiene que descontar el futuro, ponerle un precio a la espera. Ese precio es la tasa de interés, que en su forma genuina no es más que la paciencia de la sociedad vuelta cifra.',
        'Cuando la cifra es honesta, le dice a Jeisson la verdad sobre cuánto futuro puede construir con seguridad, y la cuenta premia conservar el manantial. Cuando está falsificada, le miente, y la mentira empuja hacia el balde. El hacha de Jeisson es la pieza de la asignación intertemporal operando en un bosque: recursos que debían fluir hacia el futuro, arrancados hacia el presente porque la señal que los guiaba estaba corrompida.',
        'No hizo falta ningún villano. No hizo falta que a nadie le importara menos la naturaleza. Bastó con corromper el dinero, que es lo mismo que corromper la cuenta, que es lo mismo que acortarle a todo el mundo el horizonte a la vez. Multiplique a Jeisson por millones de dueños de bosques, de tierras, de pesquerías, de suelos —cada uno haciendo su cuenta privada y prudente, cada uno descontando un futuro que el dinero volvió incierto— y tiene usted la deforestación de un continente, sin un solo malvado en la escena.',
    ]),
    ("Lo que se ve y lo que no se ve", [
        ...
        'Lo que no se ve es la cuenta. No se ve la cifra falsificada que volvió racional el hacha. No se ve que Jeisson, antes de cortar, hizo la aritmética de cualquier hombre prudente y le salió talar —porque el dinero con que calculaba le había borrado el futuro—. Prohibirle a Jeisson que tale, sin tocar el dinero, es pelear con el síntoma: es pedirle que actúe contra su propia cuenta, esperar que la virtud de unos cuantos venza a la aritmética de todos. Algunos resistirán por amor a la tierra. La mayoría hará la cuenta. Siempre, en todas partes, la mayoría hace la cuenta.',
        'Y conviene decir con cuidado lo que este capítulo afirma y lo que no. No digo que el dinero blando sea la única causa de que caigan los bosques. Jeisson podía talar también por otras razones —porque no fuera dueño del árbol y otro pudiera robárselo, porque un subsidio premiara la tala, porque la tierra no tuviera dueño y todos corrieran a llevarse lo que pudieran antes que el vecino—. Esas otras causas existen y son reales. Por eso le di a Jeisson un árbol que era indiscutiblemente suyo, en su propio terreno, sin subsidio ni vecino que se lo dispute. Le quité todas las demás causas para dejar una sola sobre la mesa. Y aun así, con la propiedad segura y nadie que lo empuje, Jeisson levantó el hacha —en cuanto le cambiamos el dinero, y solo por eso—.',
