...
CONTENT = [
    ...
    ("El tiempo", [
        ...
        ('Recuerde cómo empezó este libro. Empezó con el tiempo —con la preferencia temporal, con la paciencia como la materia prima de todo lo que un ser humano construye—. El dinero, el oro, la tierra: todo se puede perder y recuperar. El tiempo no. Es lo único de verdad escaso que poseemos. Por eso esta es la ironía más amarga del oro: lo llamamos escaso, lo atesoramos por escaso —y al obligarnos a gastar nuestras horas en cada transacción, nos hace derrochar a manos llenas lo único que de verdad no nos sobra. El oro cuida su propia escasez quemando la nuestra.'),
    ]),
