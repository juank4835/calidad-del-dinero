...
EXTRA_CSS = """
/* ===== Recuadros y cita (apartados, no se narran) — variante hairlines del estándar ===== */
.prose .recuadro {
  margin: 2.6rem 0; padding: 1.5rem 0;
