...
CONTENT = [
    ...
    ("El dinero vuelve a ser lo que siempre fue", [
        ...
        ('Es la maldición del oro llevada al extremo absoluto, y por partida doble. El oro no viaja bien por el espacio —cuesta una fortuna cruzarlo de un país a otro— ni por el tiempo, pero al menos se puede guardar para mañana. La energía falla en los dos ejes a la vez y sin remedio: no viaja por el espacio —el kilovatio del desierto no llega a la ciudad— ni viaja por el tiempo —el del mediodía no llega a la noche, el del verano no llega al invierno—, y a diferencia del oro, ni siquiera se puede guardar mientras tanto. Un kilovatio que no se usa en el instante en que se genera se pierde para siempre, sin que nadie lo toque. Es la forma más pura de riqueza que no viaja —tan atrapada que se desvanece en el acto—. Y durante toda la historia no hubo nada que hacer con ella: estaba ahí, real, cayendo día y noche, económicamente invisible, porque no había forma de convertirla en algo que el mundo pudiera recibir.'),
